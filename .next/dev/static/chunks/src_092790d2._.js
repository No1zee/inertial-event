...
const contentApi = {
    ...
    getBangers: async (type = 'movie', page)=>{
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${endpoint}?sort_by=vote_average.desc&vote_count.gte=1000&language=en-US&page=${randomPage}`);
    ...
    getClassics: async (type = 'movie', page)=>{
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${endpoint}?sort_by=popularity.desc&vote_average.gte=7.5&${dateFilter}&language=en-US&page=${randomPage}`);
            return (res.data.results || []).map((item)=>transformToContent({
                    ...item,
                    type
                }));
    ...
    getUnderrated: async (type = 'movie', page)=>{
        try {
            const endpoint = type === 'movie' ? '/tmdb-api/discover/movie' : '/tmdb-api/discover/tv';
            const randomPage = page || 1;
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${endpoint}?sort_by=vote_average.desc&vote_count.gte=200&vote_count.lte=2000&vote_average.gte=8.0&language=en-US&page=${randomPage}`);
            return (res.data.results || []).map((item)=>transformToContent({
                    ...item,
                    type
                }));
    ...
    getFresh: async (type = 'movie', page)=>{
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${endpoint}?sort_by=popularity.desc&${dateFilter}&language=en-US&page=${randomPage}`);
            return (res.data.results || []).map((item)=>transformToContent({
                    ...item,
                    type
                }));
    ...
    getDayOneDrops: async (type = 'movie')=>{
        try {
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${endpoint}?sort_by=popularity.desc&${dateFilter}&language=en-US&page=1`);
            return (res.data.results || []).map((item)=>transformToContent({
                    ...item,
                    type
                }));
...
"[project]/src/app/(dashboard)/browse/tv-shows/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const TV_RAILS = [
    {
        id: "day1",
        title: "Day 1 Drops 💧",
        fetcher: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$content$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contentApi"].getDayOneDrops('tv')
    },
    {
        id: "fresh",
        title: "Fresh Seasons 🔥",
        fetcher: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$content$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contentApi"].getFresh('tv')
    },
    {
        id: "bangers",
        title: "Binge-Worthy Bangers 💯",
        fetcher: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$content$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contentApi"].getBangers('tv')
    },
    {
        id: "underrated",
        title: "Underrated Series 💎",
        fetcher: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$content$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contentApi"].getUnderrated('tv')
    },
    {
        id: "classics",
        title: "TV Hall of Fame 🏆",
        fetcher: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$content$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contentApi"].getClassics('tv')
    },
    {
        id: "drama",
        title: "Gripping Dramas",
        fetcher: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$content$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contentApi"].getByGenre(18, 'tv')
    },
    {
        id: "scifi",
        title: "Sci-Fi & Fantasy",
        fetcher: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$content$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contentApi"].getByGenre(10765, 'tv')
    }
];
function TVShowsPage() {
    _s();
    const { data: popular } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "popular",
            "tv",
            "hero"
        ],
        queryFn: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$content$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contentApi"].getPopularTV,
        staleTime: 1000 * 60 * 10
    });
    const [rails, setRails] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(TV_RAILS);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TVShowsPage.useEffect": ()=>{
            ...
            const shuffled = others.sort({
                "TVShowsPage.useEffect.shuffled": ()=>Math.random() - 0.5
            }["TVShowsPage.useEffect.shuffled"]);
            setRails([
                first,
                ...shuffled
            ]);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: rails.map((config)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AsyncRail, {
                        config: config
                    }, config.id, false, {
                        fileName: "[project]/src/app/(dashboard)/browse/tv-shows/page.tsx",
                        lineNumber: 44,
...
_s(TVShowsPage, "NgHg3OYplL0U2ACgsjTdMAtHaS0=", false, function() {
    return [
...
//# sourceMappingURL=src_092790d2._.js.map