...
const RAIL_CONFIGS = [
    {
        id: "trending",
        title: "Trending Now",
        fetcher: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$content$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contentApi"].getTrending
    },
    {
        id: "popular_tv",
        title: "Popular Series",
        fetcher: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$content$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contentApi"].getPopularTV
    },
    {
        id: "scifi",
    ...
    },
    {
        ...
        fetcher: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$content$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contentApi"].getByGenre(99, 'movie')
    },
    {
        id: "drama",
        title: "Award Winning Dramas",
        fetcher: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$content$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contentApi"].getByGenre(18, 'movie')
    },
    {
        id: "thriller",
        title: "Psychological Thrillers",
        fetcher: ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2f$content$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["contentApi"].getByGenre(53, 'movie')
    },
    {
        id: "family",
...
function DashboardPage() {
    _s();
    const { sidebarOpen } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2f$uiStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUIStore"])();
    const [visibleCount, setVisibleCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(4); // Start with 4 rails
    ...
    const isInView = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$utils$2f$use$2d$in$2d$view$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useInView"])(sentinelRef, {
        amount: 0.1
    });
            ...
            if (isInView && visibleCount < RAIL_CONFIGS.length) {
                ...
                const timeout = setTimeout({
                    "DashboardPage.useEffect.timeout": ()=>{
                        setVisibleCount({
                            "DashboardPage.useEffect.timeout": (prev)=>Math.min(prev + 2, RAIL_CONFIGS.length)
                        }["DashboardPage.useEffect.timeout"]);
                    }
                }["DashboardPage.useEffect.timeout"], 500); // Small delay for effect
                return ({
                    "DashboardPage.useEffect": ()=>clearTimeout(timeout)
                })["DashboardPage.useEffect"];
            }
        }
    }["DashboardPage.useEffect"], [
        ...
        "DashboardPage.useEffect": ()=>{
            if (trending && trending.length > 0) {
                ...
                const shuffled = [
                    ...
                    "DashboardPage.useEffect.shuffled": ()=>Math.random() - 0.5
                }["DashboardPage.useEffect.shuffled"]).slice(0, 5);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    RAIL_CONFIGS.slice(0, visibleCount).map((config)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AsyncRail, {
                            config: config
                        }, config.id, false, {
                            fileName: "[project]/src/app/(dashboard)/page.tsx",
                            lineNumber: 75,
                    ...
                    visibleCount < RAIL_CONFIGS.length && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ref: sentinelRef,
...
_s(DashboardPage, "YMM2f3YXBnGEJXsyCUZp3Lf9Wfc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$store$2f$uiStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUIStore"],
...
//# sourceMappingURL=src_4e4714ec._.js.map