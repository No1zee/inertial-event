...
async function importHLS(loader, callbacks = {}) {
    ...
    try {
        ...
        if (ctor && !!ctor.isSupported) {
            ...
            throw Error(("TURBOPACK compile-time truthy", 1) ? "[vidstack] failed importing `hls.js`. Dynamic import returned invalid constructor." : "TURBOPACK unreachable");
        }
        return ctor;
    } catch (err) {
...
async function loadHLSScript(src, callbacks = {}) {
    ...
    try {
        ...
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$vidstack$2f$react$2f$dev$2f$chunks$2f$vidstack$2d$D_bWd66h$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFunction"])(window.Hls)) {
            throw Error(("TURBOPACK compile-time truthy", 1) ? "[vidstack] failed loading `hls.js`. Could not find a valid `Hls` constructor on window" : "TURBOPACK unreachable");
        }
...
//# sourceMappingURL=node_modules_%40vidstack_react_dev_chunks_vidstack-3ZPG_odG_482b51b6.js.map