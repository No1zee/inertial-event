...
const WebviewPlayer = /*#__PURE__*/ _s((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["forwardRef"])(_c = _s(({ src, title, initialVolume = 1, subtitleStyle, onEnded, onStateUpdate }, ref)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WebviewPlayer.useEffect": ()=>{
            ...
            const onDidFailLoad = {
                "WebviewPlayer.useEffect.onDidFailLoad": (e)=>console.log('❌ Webview: did-fail-load', e.errorCode, e.errorDescription)
            }["WebviewPlayer.useEffect.onDidFailLoad"];
            const onCrashed = {
                "WebviewPlayer.useEffect.onCrashed": (e)=>console.log('💥 Webview: crashed', e)
            }["WebviewPlayer.useEffect.onCrashed"];
...
//# sourceMappingURL=src_0d127823._.js.map