        ...
        <html lang="en">
            <head>
                ...
                <meta
                    ...
                    content="default-src 'self' app: proxy: http://localhost:3000 ws://localhost:3000; script-src 'self' 'unsafe-eval' 'unsafe-inline' app: http://localhost:3000 https://vercel.live; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com app: http://localhost:3000; font-src 'self' https://fonts.gstatic.com data: app: http://localhost:3000 https://r2cdn.perplexity.ai; img-src 'self' data: blob: https://*.tmdb.org https://*.themoviedb.org https://*.youtube.com https://i.ytimg.com https://* app: proxy: http://localhost:3000; connect-src 'self' ws: wss: https://inertial-event.vercel.app https://novastream.app https://api.jikan.moe https://*.jikan.moe https://*.themoviedb.org https://*.tmdb.org https://*.vidlink.pro https://vidlink.pro https://*.vidsrc.me https://vidsrc.me https://*.vidsrc.icu https://vidsrc.icu http://localhost:3000 ws://localhost:3000 http://localhost:5000 app: proxy: https://vercel.live; media-src 'self' blob: https: http: app: proxy: http://localhost:3000; frame-src 'self' https://*.youtube.com https://*.vidlink.pro https://vidlink.pro https://*.vidsrc.me https://vidsrc.me https://*.vidsrc.icu https://vidsrc.icu app: http://localhost:3000 https://vercel.live; object-src 'none'; child-src 'none'; worker-src 'self' blob: app: http://localhost:3000; manifest-src 'self' app: http://localhost:3000; upgrade-insecure-requests;"
                />
