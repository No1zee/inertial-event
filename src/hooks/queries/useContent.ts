...
export function useUpcoming() {
  return useQuery({
    ...
    queryFn: () => contentApi.getUpcoming(),
...
export function useProviderContent(
  providerId: string,
  type: 'movie' | 'tv' = 'movie',
...
export function useProviderGenre(
  providerId: string,
  genreId: number,
  type: 'movie' | 'tv' = 'movie',
  sort_by: string = 'popularity.desc'
...
export function useProviderClassics(providerId: string, type: 'movie' | 'tv' = 'movie') {
  return useQuery({
    ...
    queryFn: () => {
      const dateFilter =
        type === 'movie' ? { 'primary_release_date.lte': '2010-01-01' } : { 'first_air_date.lte': '2010-01-01' };
