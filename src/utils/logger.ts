...
export const logger = {
  ...
  info: (context: string, message: string, data?: unknown) => logger.log('info', context, message, data),
  warn: (context: string, message: string, data?: unknown) => logger.log('warn', context, message, data),
  error: (context: string, message: string, data?: unknown) => logger.log('error', context, message, data),
  debug: (context: string, message: string, data?: unknown) => logger.log('debug', context, message, data),
};
